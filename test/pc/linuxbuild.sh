...
# grep -c, not -q: -q exits early and SIGPIPEs strings, which pipefail
# would report as failure on a perfectly good build.
strings build/us_pc/sm64.us.f3dex2e | grep -c BINGO64_TOAST_DEMO >/dev/null \

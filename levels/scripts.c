...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_STAR_ORANGE,             star_orange_geo),
    LOAD_MODEL_FROM_GEO(MODEL_STAR_PINK,               star_pink_geo),
    LOAD_MODEL_FROM_GEO(MODEL_STAR_PURPLE,             star_purple_geo),

...
const LevelScript level_main_menu_entry_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_0,               geo_menu_numpad_0),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_1,               geo_menu_numpad_1),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_2,               geo_menu_numpad_2),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_3,               geo_menu_numpad_3),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_4,               geo_menu_numpad_4),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_5,               geo_menu_numpad_5),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_6,               geo_menu_numpad_6),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_7,               geo_menu_numpad_7),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_8,               geo_menu_numpad_8),
    LOAD_MODEL_FROM_GEO(MODEL_MAIN_MENU_NUMPAD_9,               geo_menu_numpad_9),

...
// Bingo64: pool starts lower than vanilla (0x8005C000) for extra memory.
#define SEG_START         0x80025C00
...
#define SEG_POOL_SIZE     0x19B400 // Bingo64: extended pool (vanilla 0x165000)

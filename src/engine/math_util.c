...
// Bingo64: the game's RNG is MT19937 (see engine/rand.c) so that boards and
// randomized behavior are reproducible from the seed. The vanilla LCG below is
...
UNUSED static u16 old_random_u16(void) {

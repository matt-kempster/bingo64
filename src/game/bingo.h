...
enum BingoObjectiveIcon {
    ...
    BINGO_ICON_KILL_WHOMPS,
    BINGO_ICON_KILL_BOOS,
    BINGO_ICON_KILL_SNUFITS,
    BINGO_ICON_HURT_BY_CLAMS,
    BINGO_ICON_KILL_FLY_GUYS,
    BINGO_ICON_KILL_MR_BLIZZARDS,
    BINGO_ICON_KILL_SKEETERS,
    BINGO_ICON_KILL_KOOPAS,
    BINGO_ICON_CRUSHED,
    BINGO_ICON_SPLATOON,
...
enum BingoObjectiveUpdate
{
    ...
    BINGO_UPDATE_KILLED_WHOMP,
    BINGO_UPDATE_KILLED_BOO,
    BINGO_UPDATE_KILLED_SNUFIT,
    BINGO_UPDATE_BITTEN_BY_CLAM,
    BINGO_UPDATE_KILLED_FLY_GUY,
    BINGO_UPDATE_KILLED_MR_BLIZZARD,
    BINGO_UPDATE_KILLED_SKEETER,
    BINGO_UPDATE_KILLED_KOOPA,
    BINGO_UPDATE_CRUSHED_BY_CRUSHER,
    ...
    BINGO_UPDATE_SPLATOON_PAINTED,
    // Fired by bingo_update itself whenever the HUD's life counter
    // changes value (it watches gHudDisplay.lives on the frame update).
    BINGO_UPDATE_LIVES,

    BINGO_UPDATE_DEATH_FLAGS_BEGIN,
    BINGO_UPDATE_DEATH_STANDING = BINGO_UPDATE_DEATH_FLAGS_BEGIN,
    BINGO_UPDATE_DEATH_ON_BACK,
    BINGO_UPDATE_DEATH_ON_STOMACH,
    BINGO_UPDATE_DEATH_DROWNED,
    BINGO_UPDATE_DEATH_IN_WATER,
    BINGO_UPDATE_DEATH_QUICKSAND,
    BINGO_UPDATE_DEATH_SHOCKED,
    BINGO_UPDATE_DEATH_GAS,
    BINGO_UPDATE_DEATH_EATEN,
    BINGO_UPDATE_DEATH_SQUISHED,

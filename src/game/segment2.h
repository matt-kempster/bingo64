...
// extern u8 seg2_texture_checkmark[];
// extern u8 seg2_texture_failed[];
extern u8* bingo_special_icon_lut[2];
...
extern Gfx my_fancy_custom_text_dl[];
extern void *seg2_tiny_font_lut[];

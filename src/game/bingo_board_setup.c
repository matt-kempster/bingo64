...
struct ObjectiveWeight sWeightsMedium[] = {
    ...
    { BINGO_OBJECTIVE_KILL_WHOMPS, 6, 1 },
    { BINGO_OBJECTIVE_KILL_BOOS, 8, 2 },
    { BINGO_OBJECTIVE_KILL_SNUFITS, 6, 1 },
    { BINGO_OBJECTIVE_HURT_BY_CLAMS, 8, 1 },
    { BINGO_OBJECTIVE_KILL_FLY_GUYS, 6, 1 },
    { BINGO_OBJECTIVE_KILL_MR_BLIZZARDS, 6, 1 },
    { BINGO_OBJECTIVE_KILL_SKEETERS, 4, 1 },
    { BINGO_OBJECTIVE_KILL_KOOPAS, 4, 1 },
    { BINGO_OBJECTIVE_CRUSHED, 6, 1 },
...
struct ObjectiveWeight sWeightsHard[] = {
    ...
    { BINGO_OBJECTIVE_KILL_CHUCKYAS, 6, 1 },
    // weights provisional, pre-balance-solve
    { BINGO_OBJECTIVE_KILL_BOOS, 6, 1 },
    { BINGO_OBJECTIVE_HURT_BY_CLAMS, 6, 1 },
    { BINGO_OBJECTIVE_CRUSHED, 6, 1 },
...
struct ObjectiveWeight sWeightsCenter[] = {
    ...
    { BINGO_OBJECTIVE_SHOOT_CANNONS, 3, 1 },
